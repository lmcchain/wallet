...
// Copyright (c) 2017 The lmccoin developers
...
uint256 hashGenesisBlock("0x000005c1186f6bff63a516b15a5c0ed663f86d2c044064babbdec023326d85db");
static const unsigned int timeGenesisBlock = 1524041857;
...
const string strMessageMagic = "lmccoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "August 15, 2018. The lmccoin release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xf11f7859d0ecf4fcae95c921684159793542cd988fb1ea478b531296301568fa"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("lmccoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("lmccoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("lmccoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("lmccoin-miner");
    ...
    try { loop {
        ...
        printf("Running lmccoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("lmccoinMiner terminated\n");
        throw;
    }
}
