...
const QString BITCOIN_IPC_PREFIX("lmccoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click lmccoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start lmccoin: click-to-pay handler");
    else
...
{
    // clicking on lmccoin: URLs creates FileOpen events on the Mac:
